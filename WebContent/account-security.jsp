	...
	<div class="login"  style="margin-top:8%">
		<div class="main-agileits">
				<div class="form-w3agile">
					<h3>Welcome</h3>
					<center><h5 id="email"><%= session.getAttribute("userEmail") %></h5></center>
						<div class="key" style="margin-top : 20px">
							<i class="fa fa-lock" aria-hidden="true"></i>
							<input  type="password" name="Password" id="pass" required="" placeholder="Password">
							<div class="clearfix"></div>
						</div>
						<div style="display:none" id="emailAdrress"><%=session.getAttribute("userEmail")%></div>
					<center><input type="submit" value="Login" id="loginButton" class="btn btn-info"></center>
				</div>
